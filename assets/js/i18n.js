...
const DICT = {
  en: {
    ...
    'contact.heading': 'Start Your Journey With Us', 'contact.copy': 'Share your goals and we\'ll connect with you personally.',
    ...
    , 'lang.switch.en': 'EN'
    , 'lang.switch.es': 'ES'
    , 'hub.heading': 'Tu Centro de Servicios Integrales'
    , 'hub.subtitle': 'Your One-Stop Service Hub for the Hispanic Community'
    , 'hub.desc': 'Somos más que una empresa—somos tu familia de confianza. Desde comprar tu primera casa hasta preparar tus impuestos, registrar tu negocio y más, te acompañamos en cada paso con servicio 100% bilingüe.'
    , 'hub.descEn': 'We\'re more than a company—we\'re your trusted family. From buying your first home to tax preparation, business registration, and beyond, we support you every step of the way with 100% bilingual service.'
    , 'hub.feature.realestate': 'Real Estate'
    , 'hub.feature.taxes': 'Taxes'
    , 'hub.feature.credit': 'Credit'
    , 'hub.feature.immigration': 'Immigration'
    , 'hub.feature.business': 'Business'
    , 'hub.feature.admin': 'Translations'
    , 'form.helper.name': 'As it appears on official documents / Como aparece en documentos oficiales'
    , 'form.helper.email': 'We\'ll use this to contact you / Lo usaremos para contactarte'
    , 'form.helper.phone': 'Optional - for faster response / Opcional - para respuesta más rápida'
    , 'form.helper.message': 'Tell us about your needs / Cuéntanos sobre tus necesidades'
  ...
  es: {
    ...
    'contact.heading': 'Comience Su Viaje Con Nosotros', 'contact.copy': 'Comparta sus objetivos y nos conectaremos con usted personalmente.',
    ...
    , 'lang.switch.es': 'ES'
    , 'hub.heading': 'Tu Centro de Servicios Integrales'
    , 'hub.subtitle': 'Tu Centro de Servicios para la Comunidad Hispana'
    , 'hub.desc': 'Somos más que una empresa—somos tu familia de confianza. Desde comprar tu primera casa hasta preparar tus impuestos, registrar tu negocio y más, te acompañamos en cada paso con servicio 100% bilingüe.'
    , 'hub.descEn': 'Somos más que una empresa—somos tu familia de confianza. Te acompañamos en cada paso con servicio 100% bilingüe.'
    , 'hub.feature.realestate': 'Bienes Raíces'
    , 'hub.feature.taxes': 'Impuestos'
    , 'hub.feature.credit': 'Crédito'
    , 'hub.feature.immigration': 'Inmigración'
    , 'hub.feature.business': 'Negocios'
    , 'hub.feature.admin': 'Traducciones'
    , 'form.helper.name': 'Como aparece en documentos oficiales'
    , 'form.helper.email': 'Lo usaremos para contactarte'
    , 'form.helper.phone': 'Opcional - para respuesta más rápida'
    , 'form.helper.message': 'Cuéntanos sobre tus necesidades'
